...
public class Canal {
	...
	public static void crearCanal(String canal) {
		...
		try {
			...
			System.out.println("Resultado de la operaci�n 'crear canal': " + res);
	...
	public static void subscribirse(String mail, String canal) {
		...
		try {
			...
			//recibir y procesar respuesta
			int res = flujo_in.readInt();
			System.out.println("Resultado de la operaci�n 'suscribir a canal': " + res);
	...
	public static void desubscribirse(String canal) {
		...
		try {
			...
			//recibir y procesar respuesta
			int res = flujo_in.readInt();
			System.out.println("Resultado de la operaci�n 'desuscribir a canal': " + res);
